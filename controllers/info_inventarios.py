...
CATEGORIAS_VEHICULOS = {
    '15010-0000 - Vehículos automotores terrestres': [
        ...
        '15010-0017 - Camionetas (omnibus rurales)',
    ...
    '15020-0000 - Equipos ferroviarios y carros aéreos': [
        '15020-0001 - Autovias',
        '15020-0002 - Gruas ferroviárias automotores',
        '15020-0003 - Locomotoras a vapor',
        '15020-0004 - Locomotoras diesel',
        '15020-0005 - Locomotoras electricas',
        '15020-0006 - Tranvías',
    ...
    '15060-0000 - Equipos auxiliares de transporte': [
        ...
        '15060-0003 - Encerados para camion',
