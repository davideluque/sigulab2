...
'Plugins': 'Plugins',
'Por favor clickee el siguiente link http://127.0.0.1:8000/sigulab2/modulos/recoverpassword/?key=%(key)s para resetear su contraseña': 'Por favor clickee el siguiente link http://127.0.0.1:8000/sigulab2/modulos/recoverpassword/?key=%(key)s para resetear su contraseña',
'Por favor clickee el siguiente link http://sigulab2/modulos/.recoverpassword/?key=%(key)s para resetear su contrasena': 'Por favor clickee el siguiente link http://sigulab2/modulos/.recoverpassword/?key=%(key)s para resetear su contrasena',
'Por favor clickee el siguiente link http://sigulab2/modulos/.recoverpassword/?key=%(key)s para resetear su contraseña': 'Por favor clickee el siguiente link http://sigulab2/modulos/.recoverpassword/?key=%(key)s para resetear su contraseña',
'Por favor clickee el siguiente link http://sigulab2/modulos/recoverpassword/?key=%(key)s para resetear su contraseña': 'Por favor clickee el siguiente link http://sigulab2/modulos/recoverpassword/?key=%(key)s para resetear su contraseña',
'Por favor clickee el siguiente link http:/http://127.0.0.1:8000/sigulab2/modulos/recoverpassword/?key=%(key)s para resetear su contraseña': 'Por favor clickee el siguiente link http:/http://127.0.0.1:8000/sigulab2/modulos/recoverpassword/?key=%(key)s para resetear su contraseña',
'Por favor clickee el siguiente linkhttp://127.0.0.1:8000/sigulab2/modulos/recoverpassword/?key=%(key)s para resetear su contraseña': 'Por favor clickee el siguiente linkhttp://127.0.0.1:8000/sigulab2/modulos/recoverpassword/?key=%(key)s para resetear su contraseña',
'Posee': 'Posee',
